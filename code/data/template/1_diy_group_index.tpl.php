...
0
|| checktplrefresh('data/diy/group/index.htm', './template/default/common/header.htm', 1293771166, 'diy', './data/template/1_diy_group_index.tpl.php', 'data/diy', 'group/index')
|| checktplrefresh('data/diy/group/index.htm', './template/default/common/pubsearchform.htm', 1293771166, 'diy', './data/template/1_diy_group_index.tpl.php', 'data/diy', 'group/index')
|| checktplrefresh('data/diy/group/index.htm', './template/default/common/footer.htm', 1293771166, 'diy', './data/template/1_diy_group_index.tpl.php', 'data/diy', 'group/index')
|| checktplrefresh('data/diy/group/index.htm', './template/default/common/header_common.htm', 1293771166, 'diy', './data/template/1_diy_group_index.tpl.php', 'data/diy', 'group/index')
;
block_get('1,2');?>
...
<strong class="xw1 xi1">热搜: </strong><? if(is_array($_G['setting']['srchhotkeywords'])) foreach($_G['setting']['srchhotkeywords'] as $val) { if($val=trim($val)) { ?><?php $valenc=rawurlencode($val); ?><?
$__FORMHASH = FORMHASH;$srchhotkeywords[] = <<<EOF
<a href="search.php?mod=search&amp;srchtxt={$valenc}&amp;formhash={$__FORMHASH}&amp;searchsubmit=true" target="_blank" class="xi2">{$val}</a>
EOF;
?>
...
<!--[diy=diy5]--><div id="diy5" class="area"><div id="frame264pvE" class="frame move-span cl frame-1-1"><div id="frame264pvE_left" class="column frame-1-1-l"><div id="frame264pvE_left_temp" class="move-span temp"></div><?php block_display('1'); ?></div><div id="frame264pvE_center" class="column frame-1-1-r"><div id="frame264pvE_center_temp" class="move-span temp"></div><?php block_display('2'); ?></div></div></div><!--[/diy]-->
</div>
