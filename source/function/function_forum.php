 ...
 *
 *      $Id: function_forum.php 18470 2010-11-24 06:10:04Z monkey $
 */
...
function dunlink($attach) {
	...
	if($remote) {
		...
		$filename = str_replace(SAE_STORAGE_DOMAIN,'',$filename);
		$s = new SaeStorage();
		$s->delete ('discuzx',$filename); 
		$s->delete ('discuzx',$filename.'.thumb.jpg'); 
