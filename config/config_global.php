...
define('SAE_STORAGE_DOMAIN','http://'.$_SERVER['HTTP_APPNAME'].'-discuzx.stor.sinaapp.com/');

$_config = array();

// ----------------------------  CONFIG DB  ----------------------------- //
$_config['db']['1']['dbhost'] = 'w.rdc.sae.sina.com.cn:3307';
$_config['db']['1']['dbuser'] = SAE_ACCESSKEY;
$_config['db']['1']['dbpw'] = SAE_SECRETKEY;
$_config['db']['1']['dbcharset'] = 'utf8';
$_config['db']['1']['pconnect'] = '0';
$_config['db']['1']['dbname'] = 'app_'.$_SERVER['HTTP_APPNAME'];
$_config['db']['1']['tablepre'] = 'dzx_';

// --------------------------  CONFIG MEMORY  --------------------------- //
$_config['memory']['prefix'] = 'FFAjhf_';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'ELfE_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '35e767FTRM3klH3t';
