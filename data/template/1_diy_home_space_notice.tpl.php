...
0
|| checktplrefresh('./template/default/home/space_notice.htm', './template/default/common/simplesearchform.htm', 1293771184, 'diy', './data/template/1_diy_home_space_notice.tpl.php', './template/default', 'home/space_notice')
|| checktplrefresh('./template/default/home/space_notice.htm', './template/default/home/spacecp_poke_type.htm', 1293771184, 'diy', './data/template/1_diy_home_space_notice.tpl.php', './template/default', 'home/space_notice')
|| checktplrefresh('./template/default/home/space_notice.htm', './template/default/common/userabout.htm', 1293771184, 'diy', './data/template/1_diy_home_space_notice.tpl.php', './template/default', 'home/space_notice')
;?>
<?php $_G['home_tpl_titles'] = array('提醒'); include template('common/header'); ?><div id="pt" class="bm cl"><? if($_G['setting']['search']) { ?><?php $slist = array(); if($_G['fid'] && $_G['forum']['status'] != 3 && $mod != 'group') { ?><?
$slist[forumfid] = <<<EOF
