...
0
|| checktplrefresh('./template/default/member/login_simple.htm', './template/default/common/seccheck.htm', 1293771158, '1', './data/template/1_1_member_login_simple.tpl.php', './template/default', 'member/login_simple')
;?>
<? if(CURSCRIPT != 'member') { ?>
