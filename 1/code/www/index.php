    ...
    <div id="mainIndex">
        ...
        <div id="riIndex">
            ...
            <div id="board_2" class="blk02 _board_head" style="display:none">
	            <h2><span><a href="/bbs/forumdisplay.php?fid=2" target="_blank" class="more01">More..</a></span>车迷活动</h2>
                <ul class="listSty">
                </ul>
            </div>
            ...
            <div class="blk01 _board_head">
				<div style="text-align:center; padding-top:8px;">
					<a href="http://bbs.powerstation.org.cn/viewthread.php?tid=747&page=1&extra=#pid6903" target="_blank"><img src="images/muRoom.jpg" width="270" /></a>
				</div>
            </div>
            <!---->
                        
            <div id="board_5" class="blk01 _board_head">
            <h2><span><a href="/bbs/forumdisplay.php?fid=5" target="_blank">More..</a></span>火车轨迹</h2>
                <ul class="listSty">
                </ul>
			</div>            
            
            <div id="board_6" class="blk01 _board_head">
            <h2 class="titA"><span><a href="/bbs/forumdisplay.php?fid=6" target="_blank">More..</a></span>动力影音</h2>
                <ul class="listSty">
                </ul>
			</div>    
            
            <div id="board_7" class="blk01 _board_head">
            <h2 class="titA"><span><a href="/bbs/forumdisplay.php?fid=7" target="_blank">More..</a></span>无限心声</h2>
                <ul class="listSty">
                </ul>
			</div>    
        </div>
